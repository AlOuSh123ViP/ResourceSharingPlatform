...
const socials = [
  {
    ...
    viewBox: "0 0 24 24",
    link: "https://github.com/Divyam-Goel-airu-200/Resource-Sharing-Project.git"
  },
  {
    name: "LinkedIn",
    ...
    link: "https://www.linkedin.com/in/divyam-goel-144708296?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
]
    ...
    <footer
      ...
      <div className="relative h-fit w-screen flex flex-col items-center justify-center">
        ...
        <div className="w-[95vw] sm:w-[35rem] mt-4 dark:bg-[#44403C] dark:text-white">
          ...
          Sharing Platform is a college resource sharing website designed to serve as a dynamic platform for students to collaborate and share resources. Sharing Platform aims to foster an environment where students can easily access and exchange a wide range of educational materials, such as lecture notes, study guides, previous question papers, and more.
          </p>
          <p className="comfort text-center text-gray-800 font-bold mobile:text-sm dark:bg-[#44403C] dark:text-white">

        
            Contact Us:-+963-932-872-832                                   
          </p>
          <p className="comfort text-center text-gray-800 font-bold mobile:text-sm dark:bg-[#44403C] dark:text-white">
